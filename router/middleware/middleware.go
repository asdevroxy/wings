...
func SetAccessControlHeaders() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Allow-Headers", "Accept, Accept-Encoding, Authorization, Cache-Control, Content-Type, Content-Length, Origin, X-Real-IP, X-CSRF-Token, X-XSRF-Token, X-XSRF-TOKEN")
